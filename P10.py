    ...
    def Global(self,p):
        for var in p.Declaracion:
            if var[3] == 0:
                ...
                self.tradGlobal += ".lcomm " + var[1] + ", " + reserva + "\n"
                ...
                self.tradGlobal += ".lcomm " + var[1] + ", 4\n"
                self.tradGlobal += var[1] + ":\n"
                self.tradGlobal += "\t.long " + str(0) + "\n"
